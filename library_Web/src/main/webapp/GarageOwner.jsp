...
<body>
    ...
    <nav class="navbar navbar-expand-sm bg-light sticky-top px-4">
        <a class="navbar-brand" href="index.jsp">
            Library<strong class="c-logo">Management</strong>
        </a>
        ...
        <div class="collapse navbar-collapse" id="collapsibleNavbar">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="User.jsp">Student</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="Admin.jsp">Admin</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="GarageOwner.jsp">Library Staff</a>
                </li>
                <li class="nav-item">
    	...
    	<div class="row">
    		...
    		<div class="col-sm p-3 my-4 border">
    			...
    			<form action="AddGarageOwner" method="post" enctype="multipart/form-data" >
		            ...
		            <div class="py-2">
		                <input name="gname" class="form-control" type="text"  pattern="[a-zA-Z ]+" placeholder="Book Name" maxlength="80" required />
		            </div>
		            <div class="py-2">
		                <input name="phone" class="form-control" type="tel" pattern="[0-9]+" placeholder="Your Phone" maxlength="10" minlength="10" required />
		            </div>
		            <div class="py-2">
		                <input name="state" class="form-control" type="text"  pattern="[a-zA-Z ]+" placeholder="Book Description" maxlength="80" required />
		            </div>
		            <div class="py-2">
		                <input name="city" class="form-control" type="text"  pattern="[a-zA-Z ]+" placeholder="Book Language" maxlength="80" required />
		            </div>
		            <div class="py-2">
		                <input name="secVill" class="form-control" type="text"   placeholder="Book Author" maxlength="80" required />
		            </div>
		            <div class="py-2">
		                <input name="shopNo" class="form-control" type="text"   placeholder="Department" maxlength="80" required />
		            </div>
		            <div class="py-2">
		                <input name="password" class="form-control" type="password" placeholder="Your Password" required />
		            </div>
    ...
    <footer>
            Design & Develop by <a href="https://www.incapp.in">Abhishek jha</a> &copy; Reights reserved &nbsp;&nbsp;&nbsp; 
            Social Media:
