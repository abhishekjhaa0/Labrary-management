...
<head>
    ...
    <meta name="description" content="This is a Library Service website" />
    <meta name="keywords" content="best library Service comapny in noida" />
</head>
...
<body>
    ...
    <header>
        <div  data-aos="fade-right" data-aos-duration="1000" >
            <h3>
                Best Library. Best Books.
                <br />
                Be Happy & Have Knowledge.
            </h3>
            <p>
                <i class="fas fa-check-circle"></i> VERY LOW COST BOOK PRICE AVAILABLE.
                <br />
                <i class="fas fa-check-circle"></i> GET LOW PRICE FOR BOOKS AND SERVICES.
            </p>
        </div>
    ...
    <section class="mt-2 p-4 bg-light">
        <div class="row align-items-center">
            <div class="col-md">
                <img class="img-fluid" src="resource/lib1.jpg" alt="" />
            </div>
            <div class="col-md">
